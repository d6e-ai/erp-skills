...
- Use English for repository instructions, general documentation, shared skills, Singapore skills, and integration skills.
...
- Do not make the `trebit` Git/YAML write model, CLI, REST API, branch management, or migration procedure part of this repository. Preserve only valid accounting concepts in `erp-core`.
...
- Keep skill names and directory names identical. Use the naming families `erp-core`, `erp-jp-*`, and `erp-sg-*`.
